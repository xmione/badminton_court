...
if ($otherOverhead -gt 10MB) {
    ...
    Write-Output "2. Open PowerShell as Administrator and run: wsl --shutdown"
    Write-Output "3. Open PowerShell as Administrator and run: wsl --unregister docker-desktop"
    Write-Output "4. Open PowerShell as Administrator and run: wsl --unregister docker-desktop-data"
    Write-Output "5. Remove-Item `"$env:LOCALAPPDATA\Docker\wsl\disk\docker_data.vhdx`" -Force"
    Write-Output "6. Restart Docker Desktop."
    Write-Output ""
