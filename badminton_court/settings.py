...
ACCOUNT_PREVENT_ENUMERATION = False  # This might be causing the issue
# ACCOUNT_EMAIL_REQUIRED = True   // deprecated moved to SOCIALACCOUNT_EMAIL_REQUIRED
ACCOUNT_EMAIL_CONFIRMATION_EXPIRE_DAYS = 7 
ACCOUNT_EMAIL_CONFIRMATION_HMAC = False
# ACCOUNT_EMAIL_CONFIRMATION_COOLDOWN = 0 # deprecated moved to ACCOUNT_EMAIL_CONFIRMATION_COOLDOWN_SECONDS
ACCOUNT_EMAIL_CONFIRMATION_COOLDOWN_SECONDS = 0
ACCOUNT_EMAIL_CONFIRMATION_ANONYMOUS_REDIRECT_URL = '/accounts/login/'
ACCOUNT_EMAIL_CONFIRMATION_AUTHENTICATED_REDIRECT_URL = '/'
ACCOUNT_USERNAME_BLACKLIST = ['admin', 'staff', 'root']
# ACCOUNT_AUTHENTICATION_METHOD = 'email' # deprecated moved to ACCOUNT_LOGIN_METHODS
# ACCOUNT_USERNAME_REQUIRED = False # deprecated moved to ACCOUNT_SIGNUP_FIELDS
